...
OrgChart.prototype.load = function(t) {
    ...
    this.server.read(t, this.width(), this.height(), e, C, y, function(t) {
        ...
        if (OrgChart.events.publish("render", [v, e]), r = e.content, r += v.ui.lonely(v.config), C !== OrgChart.action.exporting) {
            C !== OrgChart.action.centerNode && C !== OrgChart.action.insert && C !== OrgChart.action.expand && C !== OrgChart.action.collapse && C !== OrgChart.action.update || (n = a), C === OrgChart.action.init && null != a && (n = a), v.response = t;
            ...
            } else v.element.innerHTML = v.ui.css() + v.ui.exportMenuButton(v.config) + m, v._attachInitEventHandlers(), v._attachEventHandlers(), v.xScrollUI.create(v.width(), v.config.padding), v.xScrollUI.setPosition(), v.xScrollUI.addListener(v.getSvg()), v.yScrollUI.create(v.height(), v.config.padding), v.yScrollUI.setPosition(), v.yScrollUI.addListener(v.getSvg()), v.config.enableSearch && v.searchUI.addSearchControl(), v.toolbarUI.init(v, v.config.toolbar);
            var c = !1;
            ...
            C === OrgChart.action.centerNode ? OrgChart.anim(v.getSvg(), {
                viewbox: a
            }, {
            ...
            }) : !a || !v.response || a[0] == v.response.viewBox[0] && a[1] == v.response.viewBox[1] && a[2] == v.response.viewBox[2] && a[3] == v.response.viewBox[3] || C !== OrgChart.action.insert && C !== OrgChart.action.expand && C !== OrgChart.action.collapse && C !== OrgChart.action.update && C !== OrgChart.action.init ? 0 == g[0].length && (c || (O && O(), OrgChart.events.publish("redraw", [v]), c = !0)) : OrgChart.anim(v.getSvg(), {
                viewbox: a
            }, {
                viewbox: v.response.viewBox
    ...
    if (null != i) {
        ...
        if (null != a) {
            ...
            m.setAttribute("x", O.ripple.rect ? O.ripple.rect.x : 0), m.setAttribute("y", O.ripple.rect ? O.ripple.rect.y : 0), m.setAttribute("width", O.ripple.rect ? O.ripple.rect.width : i.w), m.setAttribute("height", O.ripple.rect ? O.ripple.rect.height : i.h), m.setAttribute("rx", O.ripple.radius), m.setAttribute("ry", O.ripple.radius), C.setAttribute("clip-path", "url(#" + y + ")"), C.setAttribute("cx", o), C.setAttribute("cy", l), C.setAttribute("r", 0), C.setAttribute("fill", O.ripple.color), C.setAttribute("class", "ripple"), u.appendChild(m), f.appendChild(u), f.appendChild(C), a.appendChild(f), OrgChart.anim(C, {
                r: 0,
                opacity: 1
            }, {
                r: p,
    ...
    this.update(t);
    var n = t.pid;
    null == n && (n = t.stpid), this._draw(!1, OrgChart.action.update, {
        id: n
    }, function() {
    ...
    var a = [];
    return this.remove(t, a), this._draw(!1, OrgChart.action.update, null, function() {
    ...
    var r = this.get(t);
    if (e || (e = []), r)
        for (var i = this.config.nodes.length - 1; 0 <= i; i--) this.config.nodes[i].pid != t && this.config.nodes[i].stpid != t || (this.config.nodes[i].pid = r.pid, this.config.nodes[i].stpid = r.stpid, e.push(this.config.nodes[i].id)), this.config.nodes[i].id == t && this.config.nodes.splice(i, 1);
    return this
    ...
    Array.isArray(c) || (c = [c]), Array.isArray(g) || (g = [g]), Array.isArray(p) || (p = [p]), y = setInterval(function() {
...
}, void 0 === OrgChart && (OrgChart = {}), OrgChart.VERSION = "7.1.95", OrgChart.orientation = {}, OrgChart.orientation.top = 0, OrgChart.orientation.bottom = 1, OrgChart.orientation.right = 2, OrgChart.orientation.left = 3, OrgChart.orientation.top_left = 4, OrgChart.orientation.bottom_left = 5, OrgChart.orientation.right_top = 6, OrgChart.orientation.left_top = 7, OrgChart.CENTER = 8, OrgChart.ORIENTATION = 9, OrgChart.TEXT_THRESHOLD = 250, OrgChart.IMAGES_THRESHOLD = 70, OrgChart.LINKS_THRESHOLD = 150, OrgChart.EXPCOLL_THRESHOLD = 40, OrgChart.ANIM_THRESHOLD = 50, OrgChart.ID = "id", OrgChart.PID = "pid", OrgChart.STPID = "stpid", OrgChart.TAGS = "tags", OrgChart.NODES = "nodes", OrgChart.ELASTIC = "elastic", OrgChart.MAX_DEPTH = 200, OrgChart.SCALE_FACTOR = 1.44, OrgChart.LAZY_LOADING_FACTOR = 500, OrgChart.action = {}, OrgChart.action.expand = 0, OrgChart.action.collapse = 1, OrgChart.action.maximize = 101, OrgChart.action.minimize = 102, OrgChart.action.expandCollapse = 501, OrgChart.action.edit = 1, OrgChart.action.zoom = 2, OrgChart.action.ctrlZoom = 22, OrgChart.action.scroll = 41, OrgChart.action.xScroll = 3, OrgChart.action.yScroll = 4, OrgChart.action.none = 5, OrgChart.action.init = 6, OrgChart.action.update = 7, OrgChart.action.pan = 8, OrgChart.action.centerNode = 9, OrgChart.action.resize = 10, OrgChart.action.insert = 11, OrgChart.action.insertfirst = 12, OrgChart.action.details = 13, OrgChart.action.exporting = 14, OrgChart.none = 400001, OrgChart.scroll = {}, OrgChart.scroll.visible = 1, OrgChart.scroll.smooth = 12, OrgChart.scroll.speed = 120, OrgChart.scroll.safari = {
    smooth: 12,
    speed: 250
}, OrgChart.match = {}, OrgChart.match.height = 100001, OrgChart.match.width = 100002, OrgChart.match.boundary = 100003, OrgChart.COLLAPSE_PARENT_NEIGHBORS = 1, OrgChart.COLLAPSE_SUB_CHILDRENS = 2, OrgChart.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED = 3, OrgChart.normal = 0, OrgChart.mixed = 1, OrgChart.tree = 2, OrgChart.treeLeftOffset = 3, OrgChart.treeRightOffset = 4, OrgChart.nodeOpenTag = '<g node-id="{id}" style="opacity: {opacity}" transform="matrix(1,0,0,1,{x},{y})" class="{class}" sl="{sl}" {lcn}>', OrgChart.linkOpenTag = '<g link-id="[{id}][{child-id}]" class="{class}">', OrgChart.expcollOpenTag = '<g control-expcoll-id="{id}" transform="matrix(1,0,0,1,{x},{y})"  style="cursor:pointer;">', OrgChart.linkFieldsOpenTag = '<g transform="matrix(1,0,0,1,{x},{y}) rotate({rotate})">', OrgChart.grCloseTag = "</g>", OrgChart.IT_IS_LONELY_HERE = '<g transform="translate(-100, 0)" style="cursor:pointer;"  control-add="control-add"><text fill="#039be5">{link}</text></g>', OrgChart.RES = {}, OrgChart.RES.IT_IS_LONELY_HERE_LINK = "It's lonely here, add your first node", OrgChart.MAX_NODES_MESS = "The trial has expired or 200 nodes limit was reached! <br /><a style='color: #039BE5;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>", OrgChart.OFFLINE_MESS = "The evaluation version requires intermet connection! <br /><a style='color: #039BE5;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>", OrgChart.SEARCH_PLACEHOLDER = "Search", OrgChart.A4w = 595, OrgChart.A4h = 842, OrgChart.A3w = 842, OrgChart.A3h = 1191, OrgChart.A2w = 1191, OrgChart.A2h = 1684, OrgChart.A1w = 1684, OrgChart.A1h = 2384, OrgChart.Letterw = 612, OrgChart.Letterh = 791, OrgChart.Legalw = 612, OrgChart.Legalh = 1009, OrgChart.MOVE_STEP = 5, OrgChart.MOVE_INTERVAL = 25, OrgChart.MIXED_LAYOUT_ALL_NODES = !0, OrgChart.CLINK_CURVE = 1, OrgChart.SEARCH_RESULT_LIMIT = 10, "undefined" != typeof module && (module.exports = OrgChart), OrgChart.input = function(t, e, r, i, a, n) {
    null == i && (i = !1);
    ...
    0 == t.childrenIds.length && t.parent && this._addField(o, l, "isAssistant", "edit"), this._addField(o, n, "Add new field", "edit"), this.obj.element.appendChild(this.wrapperElement), r.addEventListener("click", function() {
        i.hide(!0)
        ...
        for (var f = this.wrapper.getElementsByTagName("div"), u = 0; u < f.length; u++) {
            (a = f[u]).addEventListener("mouseover", function() {
                ...
                if (void 0 === l[r].onClick)
                    ...
                    expandChildren: !1,
                    nodeId: n
                }) : "csv" === r ? s.obj.exportCSV() : "xml" === r && s.obj.exportXML();
    ...
    this._draw(!1, OrgChart.action.exporting, t, function(t) {
        ...
        if (r.innerHTML = t, "svg" == a.ext)
        ...
        else o._pages(a, r.querySelector("svg"), function(t) {
            var e = {
                content: r.innerHTML,
                options: a,
                pages: t,
            ...
            n || OrgChart.loading.show(o), n ? n(o, e, r.querySelector("svg")) : (e = JSON.stringify(e), OrgChart._ajax(o.config.exportUrl + "/v3", "POST", e, "arraybuffer", function(t) {
        ...
        removeForEventId: function(t) {
            for (var e in o)
                if (Array.isArray(o[e]))
                    for (var r = o[e].length - 1; 0 <= r; r--) o[e][r].event_id == t && o[e].splice(r, 1)
        },
    ...
    if (this.config.enableDragDrop) {
        ...
        if (!1 !== OrgChart.events.publish("drag", [this, a])) {
            ...
            var x = this,
                ...
                I = x.getScale(),
                A = t.cloneNode(!0);
            b.insertBefore(A, b.firstChild), A.style.opacity = .7;
            var L = function(t, e) {
                    if (null != t) {
                        e.style.opacity = 1;
                ...
                n = function(t) {
                    if (w) {
                        var e = OrgChart._getClientXY(t),
                            ...
                            a = {
                                left: x.width() - (i.x + x.config.padding) < 0,
                                right: i.x - x.config.padding < 0,
                                down: x.height() - (i.y + x.config.padding) < 0,
                                up: i.y - x.config.padding < 0
                            };
                        if (a.left || a.right || a.up || a.down) {
                            ...
                            x.startMove(a, function(t) {
                                k[4] = n + t.x, k[5] = o + t.y, w.x = l - t.xWithoutScale, w.y = s - t.yWithoutScale, e.x = h - t.xWithoutScale, e.y = d - t.yWithoutScale, A.setAttribute("transform", "matrix(" + k.toString() + ")")
                            })
                        } else {
                            if (x.stopMove(), b.classList && (b.classList.add("cursor-grab"), b.classList.remove("cursor-move"), b.classList.remove("cursor-nodrop"), b.classList.remove("cursor-copy")), L(O, v), v = O = null, x.config.enableDragDrop)
                                for (; null != r && r != b;) {
                            ...
                            if (null != O) {
                                ...
                                for (var g = x.getNode(O), p = OrgChart.getStParentNodes(g), f = 0; f < p.length; f++) {
                                    ...
                                    u && (u.style.opacity = .1)
                                }!x._canUpdateLink(y.id, O) && b.classList ? (b.classList.remove("cursor-grab"), b.classList.remove("cursor-move"), b.classList.remove("cursor-copy"), b.classList.add("cursor-nodrop")) : b.classList && (b.classList.remove("cursor-grab"), b.classList.remove("cursor-move"), b.classList.add("cursor-copy"), b.classList.remove("cursor-nodrop"))
                            }
                            var m = (e.x - w.x) / I,
                                C = (e.y - w.y) / I;
                ...
                o = function(t) {
                    if (x.stopMove(), b.classList && (b.classList.remove("cursor-grab"), b.classList.remove("cursor-move"), b.classList.remove("cursor-nodrop"), b.classList.remove("cursor-copy")), b.removeEventListener(i.move, n), b.removeEventListener(i.up, o), i.leave && b.removeEventListener(i.leave, o), y.id == O || null == O) return b.removeChild(A), void(x._gragStartedId = null);
                    var e = x.getNode(O);
...
OrgChart.prototype._mouseDownHandler = function(t, e, r) {
    ...
    0 < t.children.length && (r.c = OrgChart.remote._convertToIdArray(t.children)), 0 < t.stChildren.length && (r.v = OrgChart.remote._convertToIdArray(t.stChildren)), null != t.layout && 0 != t.layout && (r.l = t.layout), t.isAssistant && (r.a = 1), t.isSplit && (r.s = t.isSplit), t.padding && (r.q = t.padding), t.lcn && (r.k = t.lcn), t.stContainerNodes && (r.b = OrgChart.remote._convertToIdArray(t.stContainerNodes)), t._m && (r.m = t._m.id), t.isPartner && (r.i = t.isPartner), t.hasPartners && (r.g = t.hasPartners), t.ppid && (r.u = t.ppid), e.push(r);
    ...
    for (var r in t) {
        var i = t[r];
        e[r] || (e[r] = []), e[r][0] = i.orientation, e[r][1] = i.levelSeparation, e[r][2] = i.mixedHierarchyNodesSeparation, e[r][3] = i.subtreeSeparation, e[r][4] = i.siblingSeparation, e[r][5] = i.layout, e[r][6] = i.columns, e[r][7] = i.collapse, e[r][8] = i.assistantSeparation, e[r][9] = i.partnerSeparation, e[r][10] = i.partnerNodeSeparation
    }
    return e
    ...
    OrgChart.LIMIT_NODES || (s.l = !0), null != OrgChart.remote._fromReqDTO ? OrgChart.remote._fromReqDTO(s.n, s.r, s.c, function(t) {
    ...
    this.config = t, this.layoutConfigs = e, this.visibleNodeIds = [], this.viewBox = null, this.action = null, this.actionParams = null, this.nodes = {}, this.oldNodes = {}, this.maxX = null, this.maxY = null, this.minX = null, this.minY = null, this.bordersByRootIdAndLevel = null, this.roots = null
    ...
    if (t) {
        ...
        a != OrgChart.action.exporting && (this.maxX = h, this.maxY = d, this.minX = c, this.minY = g, this.roots = f, this.nodes = u, this.visibleNodeIds = m.visibleNodeIds), m.bordersByRootIdAndLevel = p, m.roots = f, o(m)
    } else this.oldNodes = u || null, this._read(function(t) {
        ...
        e.notif = t.limit, e.roots = f, e.bordersByRootIdAndLevel = p, a != OrgChart.action.exporting && (s.maxX = h, s.maxY = d, s.minX = c, s.minY = g, s.roots = f, s.nodes = u, s.visibleNodeIds = e.visibleNodeIds, s.bordersByRootIdAndLevel = p), o(e)
    }, l)
    ...
    var o = e.nodes,
        l = e.roots,
        r = OrgChart.remote;
    null == r && (r = OrgChart.local), r._setPositions(l, this.layoutConfigs, function(t) {
        ...
        for (var e = {
                ...
                maxX: null,
                maxY: null
            }, r = {}, i = 0; i < l.length; i++) OrgChart.server._setMinMaxXYIterate(l[i], l[i], e, 0, r);
        a({
            minX: e.minX,
            minY: e.minY,
            maxX: e.maxX,
            maxY: e.maxY,
            bordersByRootIdAndLevel: r,
            nodes: o,
            roots: l,
            limit: t
        })
    ...
    t.isPartner ? t.sl = i - 1 : t.sl = i, null == a[e.id] && (a[e.id] = {}), null == a[e.id][t.sl] && (a[e.id][t.sl] = {
        ...
        maxX: null,
        maxY: null
    }), OrgChart._setMinMaxXY(t, a[e.id][t.sl]), i++;
    ...
    for (s = 0; s < o.length && s != OrgChart.SEARCH_RESULT_LIMIT; s++) {
        for (var g = !1, p = 0; p < l.length; p++)
            ...
            for (p = 0; p < y.length; p++) {
                d = y[p], c = o[s].data[d];
                d === o[s].propertyName && (e = c, i = t, void 0, a = OrgChart.accentFold(e).indexOf(i), c = e.toString().splice(a + i.length, 0, "</mark>").splice(a, 0, "<mark>")), d != OrgChart.TAGS && (d == OrgChart.ID ? u = u + c + ", " : OrgChart._fieldIsImg(this.config, d) ? C = c : n(d) && !OrgChart._fieldIsImg(this.config, d) ? f = f + c + ", " : OrgChart._fieldIsImg(this.config, d) || (m = m + c + ", "))
            }
            ...
            l.push({
                id: o[s].id,
                node: new OrgChart.node(o[s], null, [], O),
                textId: u,
                textInNode: f,
                text: m,
                img: C
    ...
    for (var d = n[r || "base"], c = 0; c < t.childrenIds.length; c++) {
        null == (g = e[t.childrenIds[c]]).collapsed && d.collapse && d.collapse.allChildren ? g.collapsed = !0 : null == g.collapsed && (g.collapsed = !1), a == OrgChart.action.expand && -1 != s.ids.indexOf(g.id) && (g.collapsed = !1), a == OrgChart.action.collapse && -1 != s.ids.indexOf(g.id) && (g.collapsed = !0), a == OrgChart.action.expand && "all" == s.ids && (g.collapsed = !1), a == OrgChart.action.exporting && s.expandChildren && (g.collapsed = !1), a == OrgChart.action.init ? g.collapsed = d.collapse && i >= d.collapse.level - 1 && -1 == l.indexOf(g.id) : a != OrgChart.action.centerNode && a != OrgChart.action.insert || -1 != l.indexOf(g.id) && (g.collapsed = !1), g.collapsed || (g.parent = t, -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") && -1 == g.tags.indexOf("partner") && null == g.ppid || -1 == h.indexOf(t.id) && h.push(t.id), t.children.push(g))
    }
    ...
    if (OrgChart.server._initNode(e, r, s, i, c, h, d, g, p, f), e.isAssistant && (n[e.pid] || (n[e.pid] = []), n[e.pid].push(e.id)), 0 < e.subLevels && o.push(e.id), !e.isAssistant && 0 == e.childrenIds.length && e.parent && !l[e.pid]) {
        for (var u = [], m = 0, C = 0, y = 0; y < e.parent.children.length; y++) {
            var O = e.parent.children[y]; - 1 == O.tags.indexOf("partner") && -1 == O.tags.indexOf("assistant") && 0 == O.childrenIds.length ? u.push(O.id) : -1 != O.tags.indexOf("assistant") ? m++ : -1 != O.tags.indexOf("partner") && C++
        }
    ...
    null != a.orderBy && l.sort(function(t, e) {
        var r = o[t].order,
            i = o[e].order;
    ...
    if (e == OrgChart.action.init && a.expand && a.expand.nodes)
        for (h = 0; h < a.expand.nodes.length; h++)
            for (p = o[a.expand.nodes[h]]; p;) v.push(p.id), null == p.pid && null != p.stpid ? (p = o[p.stpid]).min = !1 : p = o[p.pid];
        ...
        for (p = o[r.insertedNodeId]; p;) v.push(p.id), null == p.pid && null != p.stpid ? (p = o[p.stpid]).min = !1 : p = o[p.pid];
    var k = [],
        _ = {},
        S = [],
        I = {},
    ...
    for (h = 0; h < A.length; h++) {
        ...
        for (b = 0; b < p.children.length; b++) {
            (F = p.children[b]).isAssistant || (-1 != F.tags.indexOf("right-partner") ? (F.isPartner = 1, F.children = [], M.push(F.id)) : -1 != F.tags.indexOf("left-partner") ? (F.isPartner = 2, F.children = [], E.push(F.id)) : -1 == F.tags.indexOf("partner") || T % 2 ? -1 != F.tags.indexOf("partner") && T % 2 ? (F.isPartner = 2, F.children = [], E.push(F.id), T++) : null != F.ppid ? (N[F.ppid] || (N[F.ppid] = []), N[F.ppid].push(F.id)) : L.push(F.id) : (F.isPartner = 1, F.children = [], M.push(F.id), T++))
        }
        p.children = [];
        ...
        for (b = E.length - 1; 0 <= b; b--)
            if (N[E[b]])
                for (var H = 0; H < N[E[b]].length; H++) p.children.push(o[N[E[b]][H]]), B++;
        ...
        for (b = 0; b < M.length; b++)
            if (N[M[b]])
                for (H = 0; H < N[M[b]].length; H++) p.children.push(o[N[M[b]][H]]), z++;
        L.length || !B || z ? L.length || B || !z ? L.length || 1 != B || 1 != z ? L.length || B || z ? !L.length || B || z ? L.length && (B || z) ? p.hasPartners = 7 : p.hasPartners = 1 : p.hasPartners = 6 : p.hasPartners = 5 : p.hasPartners = 4 : p.hasPartners = 3 : p.hasPartners = 2
    }
    for (h = 0; h < S.length; h++)
        for (p = o[S[h]], b = 0; b < p.subLevels; b++) {
            ...
            if (OrgChart.server._initDinamicNode(P, p.lcn), C = p.parent) {
                var U = C.children.indexOf(p); - 1 < U && (C.children.splice(U, 1), C.children.splice(U, 0, P)), P.children.push(p), P.parent = C, p.parent = P, o[P.id] = P
            }
        }
    for (var j in _) {
        ...
        for (var j in I) {
            ...
            if ((et = t[(C = o[I[j][0]].parent).lcn ? C.lcn : "base"]).layout == OrgChart.tree || et.layout == OrgChart.treeRightOffset || et.layout == OrgChart.treeLeftOffset) {
                ...
                for (b = 0; b < rt.length; b += 3) {
                    ...
                    0 != b && (V = o[rt[b - 3]]), 0 == b || G || (V = o[rt[b - 2]]), (W.parent = V).children.push(W), G && (0 != b && (V = o[rt[b - 2]]), (G.parent = V).children.push(G)), J && (0 != b && (V = o[rt[b - 1]]), (J.parent = V).children.push(J))
                }
            }
        }
    return {
    ...
    if (m.top = l - i.padding, m.left = o - i.padding, m.bottom = n + i.padding - e / v, m.right = a + i.padding - t / v, m.maxX = a, m.minX = o, m.maxY = n, m.minY = l, null == s && i.align == OrgChart.CENTER) {
        ...
        if (x - 2 * i.padding >= a - o) switch (w = (a + o) / 2 - x / 2, i.orientation) {
            ...
            case OrgChart.orientation.right_top:
                w = (o - a) / 2 - x / 2
        } else switch (w = f.x - x / 2 + OrgChart.server._getNodeWidth(f, i) / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
        ...
        if (b - 2 * i.padding >= n - l) switch (k = (n + l) / 2 - b / 2, i.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
                k = (l - n) / 2 - b / 2
        } else switch ((k = -(b / 2 - (n - l) / 2)) > -i.padding && (k = -i.padding), i.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
    ...
    if (d == OrgChart.action.centerNode || d == OrgChart.action.maximize) {
        var _ = g[c.id];
        1 == c.options.horizontal && (s[0] = _.x + _.w / 2 - s[2] / 2), 1 == c.options.vertical && (s[1] = _.y + _.h / 2 - s[3] / 2), i.sticky && (s[0] < m.left && s[0] < m.right && (s[0] = m.left > m.right ? m.right : m.left), s[0] > m.right && s[0] > m.left && (s[0] = m.left > m.right ? m.left : m.right), s[1] < m.top && s[1] < m.bottom && (s[1] = m.top > m.bottom ? m.bottom : m.top), s[1] > m.bottom && s[1] > m.top && (s[1] = m.top > m.bottom ? m.top : m.bottom))
    }
    ...
    if (OrgChart.server._isVisible(t, r, i, a)) {
        ...
        } else a !== OrgChart.action.exporting && a !== OrgChart.action.init && -1 == s.indexOf(t.id) && (h[0].push(t.id), h[1].push({
            opacity: 0
        }), h[2].push({
            opacity: 1
        }));
    ...
    node: function(t, e, r, i, a, n, o, l, s, h) {
        ...
        for (var g in d.defs && (c = c.replace("{randId}", OrgChart.ui._defsIds[t.templateName])), null == o && (o = i.nodeBinding), o) {
            ...
            if (e) {
                var f = e[p];
                if ("function" == typeof p && (f = p(h, t)), null != f && null != f && null != d[g]) c += (OrgChart._lblIsImg(i, g) || "string" != typeof f || (f = OrgChart.wrapText(f, d[g])), d[g].replace("{val}", f)).replaceAll("{ew}", t.w - (t.padding ? t.padding[1] : 0)).replaceAll("{cw}", t.w / 2).replaceAll("{randId}", OrgChart.randomId()).replaceAll("{randId2}", OrgChart.randomId())
            }
        }
        ...
        (y = y.replace("{opacity}", O), null != i.nodeMenu && "split" != t.templateName && l !== OrgChart.action.exporting) && (c += d.nodeMenuButton.replace("{id}", t.id).replace("{cw}", t.w / 2).replace("{ew}", t.w - (t.padding ? t.padding[1] : 0)));
    ...
    link: function(t, e, r, i) {
        ...
        for (var h = OrgChart.getRootOf(t).id, d = i[h][t.sl], c = 0; c < t.children.length; c++) {
            ...
            if ((g.isAssistant || 2 == g.layout) && g.rightNeighbor && g.rightNeighbor.isSplit) switch (n.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                ...
                case OrgChart.orientation.left_top:
                    f = OrgChart.ui._linkBottomToTop(g.rightNeighbor, g, o, s)
            } else if ((g.isAssistant || 2 == g.layout) && g.leftNeighbor && g.leftNeighbor.isSplit) switch (n.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
            ...
            u = u.replaceAll("{xa}", f.xa).replaceAll("{ya}", f.ya).replaceAll("{xb}", f.xb).replaceAll("{yb}", f.yb).replaceAll("{xc}", f.xc).replaceAll("{yc}", f.yc).replaceAll("{xd}", f.xd).replaceAll("{yd}", f.yd), l.push(OrgChart.linkOpenTag.replace("{id}", t.id).replace("{class}", "link " + g.tags.join(" ")).replace("{child-id}", g.id)), l.push(u);
            var C = "";
    ...
    if ("multiline" == s) {
        ...
        p = 1;
        for (var y = 1, O = 1; O < f.length; O++) {
            var v = m.firstChild.data.length;
            if (m.firstChild.data += " " + f[O], m.getComputedTextLength() > l) {
                if (m.firstChild.data = m.firstChild.data.slice(0, v), y++, 0 !== c && c < y) break;
                (m = document.createElementNS(h, "tspan")).setAttributeNS(null, "x", a), m.setAttributeNS(null, "y", n + u * p), m.setAttributeNS(null, "text-anchor", o), C = document.createTextNode(f[O]), m.appendChild(C), d.appendChild(m), p++
            }
        }
        var x = "";
        if (null != d.innerHTML) x = d.innerHTML, d.innerHTML = "";
            ...
            var b = "";
            for (O = d.childNodes.length - 1; 0 <= O; O--) b = XMLSerializer().serializeToString(d.childNodes[O]) + b, d.removeChild(d.childNodes[O]);
            x = b
        }
        return x
    }
    ...
    for (var r, i, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
        ...
        if (-1 != e.res.visibleNodeIds.indexOf(h.from) && -1 != e.res.visibleNodeIds.indexOf(h.to)) {
            ...
            switch (this.config.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    y <= O ? (b = 1, m.x = y + d.w / 10, C.x = O - c.w / 10) : (b = -1, m.x = y - d.w / 10, C.x = O + c.w / 10), p == u ? (b = 1, m.y = p, C.y = u) : u < p ? (m.y = p, C.y = u + c.h) : (m.y = p + d.h, C.y = u);
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
            ...
            l += '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", d.id).replace("{to}", c.id) + _.link.replaceAll("{d}", "M{a.x},{a.y} C{a.x},{a.y} {c.x},{c.y} {b.x},{b.y}").replaceAll("{b.x}", C.x).replaceAll("{b.y}", C.y).replaceAll("{a.x}", m.x).replaceAll("{a.y}", m.y).replaceAll("{c.x}", w.x).replaceAll("{c.y}", w.y);
    ...
    function t(t, e, r) {
        ...
        if (t.level == e.level) switch (a = e, l.orientation) {
            ...
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
                d.q = t.y + t.h, d.s = M.maxY - h, i.push([d.p, d.q]), i.push([d.r, t.y + t.h + h / 3]), s = OrgChart.t(a.templateName, a.min, L), i.push([a.x + a.w / 2 + s.expandCollapseSize, i[i.length - 1][1]]), i.push([i[i.length - 1][0], a.y + a.h]);
                break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
                d.p = t.x, d.q = t.y + t.h / 2 + s.expandCollapseSize, d.r = M.minX - h, d.s = t.y + t.h / 2 + s.expandCollapseSize, i.push([d.p, d.q]), i.push([t.x - h / 3, d.q]), s = OrgChart.t(a.templateName, a.min, L), i.push([i[i.length - 1][0], a.y + a.h / 2 + s.expandCollapseSize]), i.push([a.x, i[i.length - 1][1]]);
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                d.p = t.x + t.w, d.q = t.y + t.h / 2 + s.expandCollapseSize, d.r = M.maxX + h, d.s = t.y + t.h / 2 + s.expandCollapseSize, i.push([d.p, d.q]), i.push([t.x + t.w + h / 3, d.q]), s = OrgChart.t(a.templateName, a.min, L), i.push([i[i.length - 1][0], a.y + a.h / 2 + s.expandCollapseSize]), i.push([a.x + a.w, i[i.length - 1][1]])
        } else {
            switch (l.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
        ...
        if (A += '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", t.id).replace("{to}", e.id) + s.link.replaceAll("{d}", b), E.label) {
            ...
            A += s.label.replace("{x}", O.x).replace("{y}", O.y + _).replace("{val}", E.label)
        }
